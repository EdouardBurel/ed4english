        ...
        <div className="max-w-[800px] w-full mx-auto text-center flex flex-col justify-center px-4">
         {/* <p className="text-[#00df9a] font-bold p-4">
          ...
          <div className="flex justify-center items-center flex-wrap">
            <p className="md:text-5xl sm:text-4xl text-xl font-body py-4 whitespace-nowrap text-white">
              Avec ED4ENGLISH, développez votre :
            </p>
            <ReactTyped
              className="md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2 font-heading text-[#A7D7B9] whitespace-nowrap"
              strings={[
                "aisance orale",
                "compréhension",
          ...
          <div className="mt-12 text-center">
            <p className="md:text-2xl text-xl font-body text-gray-100">
              Formations en ligne, coaching individuel et team building pour
              entreprises
            </p>
            <button className="bg-[#A7D7B9] w-[200px] rounded-md font-body mt-6 mx-auto py-3 text-black">
