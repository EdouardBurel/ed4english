      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">Programme intensif de 15h</p>
            <p className="py-2 border-b mx-8">
              Cours individuels ou en petit groupe
            </p>
            <p className="py-2 border-b mx-8">
              Éligible au CPF (nous contacter)
            </p>
            <p className="py-2 border-b mx-8">
              Tarif : à partir de 700 € HT
            </p>
          </div>
        ...
        <div className="w-full shadow-xl bg-gray-100 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          ...
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">Anglais des affaires, technique, etc.</p>
            <p className="py-2 border-b mx-8">
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          <img
            ...
            src={Icon1} // Vous voudrez peut-être une icône différente ici
          ...
          <div className="text-center font-medium">
            <p className="py-2 border-b mx-8 mt-8">Amélioration de la fluidité</p>
            <p className="py-2 border-b mx-8">
